...
<!-- TEST EXAMPLE: create function for java plotly -->
<script>
...
<!-- FIGURE 1: SCATTERPOLOT WITH 45 DEGREE LINE -->
<script>
Plotly.d3.csv("https://raw.githubusercontent.com/cieb-unibas/female_inventors/main/Report/female_inventors_graduates_USPTO.csv?token=AJTHWUVQ2WU2CGMQ66E4TQ3ADQAXU", function(err, rows){
  ...
  var data = [{
      ...
      <!-- marker: { -->
      <!--   size: unpack(rows, 'total_graduates'), -->
      <!--   sizemode: "area", -->
      <!-- } -->
    }]
